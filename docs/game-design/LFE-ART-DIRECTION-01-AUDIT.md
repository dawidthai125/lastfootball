...
### Faza 1 — `LFE-ART-DIRECTION-02` Foundation Tokens *(docs+tokens only / presentation)*
...
### Faza 6 — `LFE-ART-ASSETS-03` Match Moments *(opcjonalnie)*
...
1. **Kierunek nazwy:** *Night Pitch Office* — akceptacja?
