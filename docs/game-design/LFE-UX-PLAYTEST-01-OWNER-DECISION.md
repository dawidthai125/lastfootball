...
**Zasada z Owner GO playtestu:** nie zmieniać projektu *przed* domknięciem sesji — **sesje domknięte**; zmiany = tylko w kolejnym EPIC (impl/polish), nie ad-hoc w Figma bez ticketu.
