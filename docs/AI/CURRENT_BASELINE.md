...
git log -1 --oneline cae2323     # Documentation tip LFE-SCOUTING-01 CLOSE (pin)
...
2026-07-30 — LFE-SCOUTING-01 CLOSED · Domain `93fd6d5` · Presentation `9fd14fc` · Docs tip `cae2323` (pin)
