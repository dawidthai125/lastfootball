...
git log -1 --oneline 3c01baa            # Domain CAREER-DECLINE-01
...
**Prod deploy:** Vercel Production śledzi `main` (Domain CAREER-DECLINE-01 `3c01baa` · presentation MOTION-01 `9fd14fc`).
...
**LFE-SOFTLOCK-01 / LFE-MESSAGES-01 / LFE-CLUB-01 / LFE-BOARD-01 / LFE-STADIUM-01 / LFE-TRANSFERS-10 / LFE-PUBLIC-API-01 / LFE-AGE-01 / LFE-LEAGUE-WORLD-02 / LFE-CAREER-DECLINE-01:** brak migracji (gate / derive / org refactor / package surface / Confirm wire / Web strength / Career Phase only).  
...
**LFE-CAREER-DECLINE-01:** `resolveCareerPhase` · Growth Gate · banded age regress · feat `3c01baa` · D124.
---
...
- Żadnego nowego EPICu (§22 / Youth Depth / Retirement / Prime / `/advanced` / Physics) bez Owner GO.
- Ticket Economy · Stadium expand · Prestige/Quest · multi-tier AI catalogs · Prime / Retirement / Youth Depth.
...
- Domain tip = **CAREER-DECLINE-01** (`3c01baa`); prior LEAGUE-WORLD-02 `843bcfd`; prior AGE-01 `6a54722`; prior RATINGS-V2 `962f0a8`; Presentation MOTION `9fd14fc`; UI P0 `54d0724`.
- Soft-lock Sponsors/Board/Stadium = **open** (D99/D105/D111); windowed: transfers/training.
- Brak: AI clubs · escrow · timeout · Physics · XP/attribute DB · Ranking ELO · Achievements XP · Messages DB · §6 engine · Stadium Ticket/expand · Board Prestige/Quest · sponsor marketplace · multi-tier AI catalogs (Variant A) / baraże · `completeLiveTransfer()` · `@lastfootball/lfe/advanced` · Prime / Retirement / Youth Depth.
- Migracje prod: training · potential · academy_track · scout_shortlist · fee helpers · season_number/season_phase · league_tier · **club_sponsor_contracts**; Messages/Club/SoftLock/Board/Stadium/TRANSFERS-10/PUBLIC-API-01/RATINGS-V2/AGE-01/LEAGUE-WORLD-02/CAREER-DECLINE-01 = brak migracji.
