...
| P7  | Progressive disclosure: Liga + Finanse open na `SEASON`; Transfery gdy `transfer_window_open`                   | LFE-HUB-01 / TRANSFERS    |
...
| P14 | `resolveClubTraining` + `last_training_on` + status-only · **CLOSED**                                           | LFE-TRAINING-01 (= D21)   |
