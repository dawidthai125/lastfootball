...
Przed PLAN / IMPLEMENT — sprawdź, czy decyzja Ownera już istnieje (D18–D23, P\*).
...
| P7   | Progressive disclosure: Liga + Finanse + **Akademia** open na `SEASON`; Transfery gdy `transfer_window_open`    | LFE-HUB-01 / TRANSFERS / ACADEMY |
...
2026-07-30 — LFE-ACADEMY-01 · D23 / P10c
