...
- **Następny EPIC (po Owner GO):** §22 push/email lub `/advanced` — SSOT [`docs/ROADMAP.md`](docs/ROADMAP.md).
...
2026-08-03 — LFE-RATINGS-V2 CLOSED · Domain `962f0a8` · tip `ac32505` · docs tip `c5c5866` · D1–D121
