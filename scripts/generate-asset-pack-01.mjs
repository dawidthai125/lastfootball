...
const nav = {
  ...
  scouting: 'M11 4a7 7 0 015.6 11.2L21 20l-1.5 1.5-4.4-4.4A7 7 0 1111 4zm0 3a4 4 0 100 8 4 4 0 000-8z',
  ...
  settings: 'M12 8a4 4 0 100 8 4 4 0 000-8zm0-4v2m0 12v2m8-8h-2M6 12H4m12.5-5.5l-1.5 1.5M9 15.5L7.5 17m9 0L15 15.5m0-7L16.5 7',
